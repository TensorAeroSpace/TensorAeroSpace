...
def rise_time(control_signal: np.ndarray, system_signal: np.ndarray, 
              low_threshold: float = 0.1, high_threshold: float = 0.9) -> Optional[float]:
    """
...
def integral_absolute_error(control_signal: np.ndarray, system_signal: np.ndarray) -> float:
    """
...
def integral_squared_error(control_signal: np.ndarray, system_signal: np.ndarray) -> float:
    """
...
def integral_time_absolute_error(control_signal: np.ndarray, system_signal: np.ndarray, dt: float = 1.0) -> float:
    """
...
def performance_index(control_signal: np.ndarray, system_signal: np.ndarray, dt: float = 1.0) -> float:
    """
