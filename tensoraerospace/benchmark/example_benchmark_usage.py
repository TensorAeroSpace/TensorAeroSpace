...
def generate_sample_system_response(time_points, overshoot=10.0, settling_time=5.0, noise_level=0.01):
    """
    ...
    if zeta < 1.0:
        ...
        response = 1 + (r2 * np.exp(r1 * time_points) - r1 * np.exp(r2 * time_points)) / (r2 - r1)
