"""
Модуль для моделирования продольного движения экспериментального самолета X-15.

Этот модуль содержит реализацию среды Gymnasium для обучения агентов управления
продольным движением самолета X-15. Среда предоставляет интерфейс для взаимодействия
с моделью самолета, включая управление углом тангажа и угловой скоростью тангажа
через руль высоты.
"""
