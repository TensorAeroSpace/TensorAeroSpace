"""
Модуль для моделирования самолета наблюдения LAPAN Surveillance Aircraft (LSU)-05 NG.

Этот модуль содержит реализацию среды Gymnasium для обучения агентов управления
продольным движением самолета LAPAN LSU-05 NG. Среда предоставляет интерфейс для
...
class LinearLongitudinalLAPAN(gym.Env):
    """Моделирование объекта управления LAPAN Surveillance Aircraft (LSU)-05 NG в среде моделирования OpenAI Gym для обучения агентов с искусственным интеллектом
