...
class NonlinearSkywalkerX8(ModelBase):
    ...
    def run_step(self, u: ArrayLike) -> np.ndarray:
        """Integrate virtual elevator/aileron radians and throttle for one sampling
        interval.

        Append state/input histories and return the selected output-state column, or all
        12 states when no selection is configured.
        """
