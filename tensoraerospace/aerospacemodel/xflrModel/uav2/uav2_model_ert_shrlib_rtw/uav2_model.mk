###########################################################################
## Makefile generated for Simulink model 'uav2_model'. 
## 
## Makefile     : uav2_model.mk
## Generated on : Sat Jul 27 17:34:53 2024
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/uav2_model_win32.dll
...
PRODUCT_NAME              = uav2_model
MAKEFILE                  = uav2_model.mk
COMPUTER                  = PCWIN
MATLAB_ROOT               = C:/PROGRA~2/MATLAB/R2015B~1
MATLAB_BIN                = C:/PROGRA~2/MATLAB/R2015B~1/bin
MATLAB_ARCH_BIN           = C:/PROGRA~2/MATLAB/R2015B~1/bin/win32
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ADMINI~1/Desktop/»õÆú´õ~1/lap
ARCH                      = win32
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = uav2_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = uav2_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uav2_model_win32.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/uav2_model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=uav2_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/uav2_model_ert_shrlib_rtw/uav2_model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/uav2_model_ert_shrlib_rtw/ert_main.c
...
OBJS = uav2_model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/uav2_model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
