"""Deprecated compatibility alias for the corrected angular F-16 initial module."""
...
warnings.warn(
    "tensoraerospace.aerospacemodel.f16.nonlinear.angular.inital is deprecated; "
    "use tensoraerospace.aerospacemodel.f16.nonlinear.angular.initial instead.",
    DeprecationWarning,
    stacklevel=2,
)
