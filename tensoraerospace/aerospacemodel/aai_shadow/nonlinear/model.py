"""Pure-numpy nonlinear 6-DoF AAI RQ-7 Shadow model (SI units)."""
...
class NonlinearAAIShadow(ModelBase):
    """Nonlinear 6-DoF AAI RQ-7A Shadow tactical UAV.

    State: ``[u, v, w, p, q, r, φ, θ, ψ, x_e, y_e, z_e]`` (SI: m/s, rad, m).
    Control: ``[δ_e, δ_a, δ_r, δ_T]`` — 4-channel mixed-V-tail
    convention (collective ruddervator, aileron, differential
    ruddervator, throttle).
    """
