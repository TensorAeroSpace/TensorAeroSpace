###########################################################################
## Makefile generated for Simulink model 'rocket_model'. 
## 
## Makefile     : rocket_model.mk
## Generated on : Sat Dec 10 14:01:24 2022
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/rocket_model_win64.dll
...
PRODUCT_NAME              = rocket_model
MAKEFILE                  = rocket_model.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = D:/MATLAB2015
MATLAB_BIN                = D:/MATLAB2015/bin
MATLAB_ARCH_BIN           = D:/MATLAB2015/bin/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = G:/tensoraerospace/model/test/rocket
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = rocket_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = rocket_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/rocket_model_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/rocket_model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=rocket_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/rocket_model_ert_shrlib_rtw/rocket_model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/rocket_model_ert_shrlib_rtw/ert_main.c
...
OBJS = rocket_model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/rocket_model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
