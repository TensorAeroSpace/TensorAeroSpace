###########################################################################
## Makefile generated for Simulink model 'f16_model'. 
## 
## Makefile     : f16_model.mk
## Generated on : Sun Dec 11 09:37:12 2022
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/f16_model_win64.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = G:/tensoraerospace/model/test/f16
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = f16_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = f16_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/f16_model_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/f16_model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=f16_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/f16_model_ert_shrlib_rtw/f16_model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/f16_model_ert_shrlib_rtw/ert_main.c
...
OBJS = f16_model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/f16_model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
