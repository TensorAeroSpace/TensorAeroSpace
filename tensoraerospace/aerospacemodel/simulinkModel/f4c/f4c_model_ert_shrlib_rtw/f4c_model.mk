###########################################################################
## Makefile generated for Simulink model 'f4c_model'. 
## 
## Makefile     : f4c_model.mk
## Generated on : Sun May 21 08:07:02 2023
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/f4c_model_win64.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/79534/OneDrive/F0A5~1/grant/TENSOR~1/TENSOR~1/AEROSP~1/SIMULI~1/f4c
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = f4c_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = f4c_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/f4c_model_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/f4c_model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=f4c_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/f4c_model_ert_shrlib_rtw/f4c_model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/f4c_model_ert_shrlib_rtw/ert_main.c
...
OBJS = f4c_model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/f4c_model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
