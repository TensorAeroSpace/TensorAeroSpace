# Recipe 11 — IHDP on the nonlinear F16
...
![Feedforward trim curve](../example/agent/ihdp/img/ihdp_nl_ff_curve.png)
...
![Reference signal](../example/agent/ihdp/img/ihdp_nl_reference.png)
...
![IHDP + FF tracking](../example/agent/ihdp/img/ihdp_nl_tracking.png)
...
[Algorithm and migration notes](../agent/ihdp.md) · [IM-GDHP recipe](12_imgdhp.md)
