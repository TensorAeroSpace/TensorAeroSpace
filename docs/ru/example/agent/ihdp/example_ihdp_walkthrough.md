...
Понятный пошаговый пример на базе `example_ihdp_beautiful.ipynb`: от создания опорного сигнала до запуска [IHDP](../../../agent/ihdp.md) и интерпретации графиков. В конце — FAQ и советы.

Для более сжатой версии того же эксперимента см. [Пример: IHDP на линейной F-16](example_ihdp.md). Для сложной задачи слежения за синусоидой на нелинейной модели — [Пример: IHDP на нелинейной F-16](example_ihdp_nonlinear.md).
...
actor_settings = {
    ...
    "learning_rate": 2.0 / 25.0 * 1,
    "learning_rate_min": 0.001 / 25.0 * 1,
...
![Переходный процесс по углу атаки](img/output_9_0.png){ width=960 }
...
![Динамика угловой скорости wz](img/output_10_1.png){ width=960 }
...
- [Обзор IHDP: алгоритм и гиперпараметры](../../../agent/ihdp.md)
- [Пример: IHDP на линейной F-16](example_ihdp.md) — сжатый вариант того же эксперимента.
- [Пример: IHDP на нелинейной F-16](example_ihdp_nonlinear.md) — слежение за синусоидой с feedforward.
- [Пример: IHDP при отказе в полёте](../../failure/ihdp-failure.md) — как онлайн-идентификация восстанавливается после изменения динамики.
