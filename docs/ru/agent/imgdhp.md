...
- **Инкрементная модель**: онлайн-идентификация локальной линейризации \(\Delta y_{t+1} = A \Delta y_t + B \Delta u_t\) методом RLS — легковесно, интерпретируемо, не требует нейросети для идентификации
...
| --- | --- | --- | --- |
| Идентификация | Известная модель | Онлайн NN | Онлайн RLS (инкрементная линейная) |
