...
Для многоканальной проверки угловых скоростей используйте CLI бенчмарка SDK ниже. Проверяйте завершение эпизода и углы самолёта вместе с ошибками слежения: конечные веса ещё не означают устойчивость.
