...
В задаче линейного B747 из `scripts/validate_ddpg.py` снижение LR критика до
...
Повторить для seed 29 и 47. Скрипт сохраняет все финальные результаты и кривые
обучения без выбора лучшего checkpoint.
