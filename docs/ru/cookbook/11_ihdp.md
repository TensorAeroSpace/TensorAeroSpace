...
IHDP нужна обоснованная начальная оценка эффективности входа. [Рецепт 06](06_online_adaptive.md) объясняет возбуждение и онлайн-идентификацию на iADP; [рецепт 14](14_aaindi.md) показывает отдельный интерфейс физических измерений AA-INDI.
...
Проверки продолжения, состояние симулятора и различия интерфейсов сохранения агентов разобраны в [рецепте 08](08_huggingface.md).
