...
Алгоритм глубокого обучения с подкреплением, сочетающий распределённое RL с принципом максимальной энтропии.

**Ключевые характеристики**:

- Распределённое RL: Моделирует полное распределение Q-функции через квантильные сети в стиле IQN
