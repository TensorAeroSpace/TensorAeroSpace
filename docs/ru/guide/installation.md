...
-   :material-apple: **macOS (Intel/M‑series)**
    ...
    Используйте совместимые версии Python (3.10–3.12). PyTorch устанавливается нативно на Apple Silicon.
...
- В проекте используется PyTorch. Для поддержки GPU установите сборку PyTorch под вашу версию CUDA (см. официальную инструкцию).
...
??? question "Конфликты версий PyTorch"
    Установите сборку PyTorch, соответствующую вашей платформе (CUDA/CPU/macOS), затем переустановите `tensoraerospace`.

??? question "macOS (M‑series)"
    Используйте Python 3.10–3.12. PyTorch устанавливается нативно на Apple Silicon из PyPI.
