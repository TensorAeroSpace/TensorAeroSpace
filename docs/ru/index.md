...
-   :material-cog-outline: **Интеграция с Gym**
    ...
    [:octicons-arrow-right-24: Подробнее](example/env/gymnasium.md)
...
- Примеры: [example/env/examples](example/env/gymnasium.md)
...
<div style="text-align:center; margin: 1.2rem 0 0.2rem;">
  ...
  <a href="example/env/gymnasium.md" class="md-button">Посмотреть примеры</a>
</div>
