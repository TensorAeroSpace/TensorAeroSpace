...
## 
## Makefile     : model.mk
## Generated on : Sun Dec 18 21:44:23 2022
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/model_win64.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Administrator/Desktop/simModel/2015
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/model_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=model -DNUMST=2 -DNCSTATES=8 -DHAVESTDIO
...
SRCS = $(START_DIR)/model_ert_shrlib_rtw/model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/model_ert_shrlib_rtw/ert_main.c
...
OBJS = model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
