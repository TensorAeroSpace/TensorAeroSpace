###########################################################################
## Makefile generated for Simulink model 'x15_model'. 
## 
## Makefile     : x15_model.mk
## Generated on : Sun May 21 08:07:17 2023
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/x15_model_win64.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/79534/OneDrive/F0A5~1/grant/TENSOR~1/TENSOR~1/AEROSP~1/SIMULI~1/x15
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = x15_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = x15_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/x15_model_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR)/x15_model_ert_shrlib_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=x15_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/x15_model_ert_shrlib_rtw/x15_model.c lcc_dll_main.c

MAIN_SRC = $(START_DIR)/x15_model_ert_shrlib_rtw/ert_main.c
...
OBJS = x15_model.obj lcc_dll_main.obj
...
%.obj : $(START_DIR)/x15_model_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
