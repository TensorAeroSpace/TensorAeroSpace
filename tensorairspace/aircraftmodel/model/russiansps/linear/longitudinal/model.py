...
from tensorairspace.aircraftmodel.model.constant import state_to_latex_rus, state_to_latex_eng
from tensorairspace.aircraftmodel.model.f16.nonlinear.utils import output2dict


class LongitudinalRussianSuperSonic(ModelBase):
    """
    Сверхзвуковой самолет в изолированном продольном канале.
    ...
    def import_linear_system(self):
        ...
        """
        self.A = np.array([
            [0.1080, 0.6140, 0.0996, -0.6388],
            [-0.2116, -1.8719, -0.1815, 1.2506],
            [0.3026, 3.9051, 0.4159, -1.7922],
            [0, 0, 1, 0],
        ])
