...
from tensorairspace.aerospacemodel import LongitudinalX15



class LinearLongitudinalX15(gym.Env, EzPickle):
    """Моделирование объекта управления LongitudinalX15 в среде моделирования OpenAI Gym для обучения агентов с искусственным интеллектом
    ...
    def __init__(self, initial_state: any,
        ...
        self.model = LongitudinalX15(initial_state, number_time_steps=number_time_steps,
    ...
    def reset(self):
        ...
        """
        self.model = None
        self.model = LongitudinalX15(self.initial_state, number_time_steps=self.number_time_steps,
