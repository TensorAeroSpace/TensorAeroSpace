...
PPO работает, оптимизируя "суррогатную" целевую функцию, которая максимирует прибыль, одновременно ограничивая степень изменения политики на каждом шаге обновления. Это обеспечивает стабильность обучения и предотвращает проблемы, возникающие при больших обновлениях политики. Рассмотрим ключевые шаги PPO:
