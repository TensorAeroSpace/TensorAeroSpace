...
![Boeing-747](img/f-16_fighting_falcon.jpg){ width=400 }

## ЛТХ

| Модификация | Boeing-747 |
|-------------|------------|
| Длина, м | 70.7 |
| Размах крыла, м | 64.4 |
| Высота самолета, м | 19.4 |
| Площадь крыла, м2 | 541.2 |
...
- [`LongitudinalB747`](../api/tensoraerospace.aerospacemodel.LongitudinalB747.md)

## Среда моделирования OpenAI Gym

- [`LinearLongitudinalB747`](../api/tensoraerospace.envs.LinearLongitudinalB747.md)
