...
## Взаимодействие с Python {#взаимодействие-с-python}
...
## Сборка среды в Unity {#сборка-среды-в-unity}
...
## Запуск в Docker (GPU/CPU, распределённо) {#запуск-в-docker-gpucpu-распределённо}
