...
def test_elv_initialization_and_run_step():
...
def test_elv_multiple_steps():
    """Cover time_step != 0 branch."""
    model = ELVRocket(x0=np.zeros(3), number_time_steps=5, dt=0.01)
...
def test_elv_get_state_conversions():
...
def test_elv_get_control_conversions():
