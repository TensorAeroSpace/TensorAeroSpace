"""Extended tests for F4CPitchEnvNormalized and LinearLongitudinalF4C to increase coverage.

Targets uncovered lines in tensoraerospace/envs/f4c.py:
- Line 61: custom reward_func branch in LinearLongitudinalF4C
- Lines 513-523: _push_history method
- Lines 910+: render() early-return paths
- Lines 974-983: close() method
...
def _make_improved_env(**overrides):
    """Factory for F4CPitchEnvNormalized with sensible defaults."""
    defaults = dict(
        initial_state=np.array([200.0, 0.0, 0.0, 0.0], dtype=np.float64),
...
# ===========================================================================
# LinearLongitudinalF4C - custom reward_func branch (line 61)
# ===========================================================================


class TestLinearLongitudinalF4CCustomReward:
...
# ===========================================================================
# F4CPitchEnvNormalized - _push_history (lines 513-523)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - close() (lines 974-983)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - render() early returns (lines 910+)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - observation normalization
# ===========================================================================
...
class TestObservationNormalization:
    ...
    def test_obs_with_nonzero_initial_state(self):
        env = _make_improved_env(
            initial_state=np.array([200.0, 0.5, 0.01, 0.01], dtype=np.float64)
        )
        obs, _ = env.reset()
        assert obs.shape == (4,)
        assert np.all(obs >= -1.0)
...
# ===========================================================================
# F4CPitchEnvNormalized - full episode rollout
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - reward computation details
# ===========================================================================
...
class TestRewardComputation:
    ...
    def test_reward_penalty_on_termination(self):
        ...
        def _forced_run_step(action):
            return np.array(
                [200.0, 0.0, 0.0, env.max_pitch_rad * 2.0], dtype=np.float64
            )
...
# ===========================================================================
# F4CPitchEnvNormalized - double reset
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - construction with various parameters
# ===========================================================================
...
class TestConstruction:
    ...
    def test_initial_action_applied_on_first_step(self):
        ...
        # F4C uses radians internally for action scaling
        expected_norm = np.deg2rad(10.0) / env.max_elevator_angle_rad
...
# ===========================================================================
# F4CPitchEnvNormalized - action history tracking (pre_previous_action)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - get_init_args value verification
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - idx properties
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - _get_obs edge cases with large state
# ===========================================================================
...
class TestGetObsEdgeCases:
    ...
    def test_obs_clips_large_pitch_error(self):
        ...
        env.state = np.array([200.0, 0.0, 0.0, 2.0], dtype=np.float64)
        obs = env._get_obs()
        assert obs.shape == (4,)
    ...
    def test_obs_clips_large_pitch_rate(self):
        ...
        env.state = np.array([200.0, 0.0, 10.0, 0.0], dtype=np.float64)
        obs = env._get_obs()
        assert abs(obs[1]) <= 1.0


# ===========================================================================
# F4CPitchEnvNormalized - max_elevator_angle_rad attribute
# ===========================================================================


class TestF4CSpecificAttributes:
    """Test F4C-specific attributes not present in X15."""

    def test_max_elevator_angle_rad(self):
        env = _make_improved_env()
        expected = float(np.deg2rad(env.max_elevator_angle_deg))
        assert env.max_elevator_angle_rad == pytest.approx(expected, abs=1e-6)

    def test_initial_elevator_rad(self):
        env = _make_improved_env(initial_elevator_deg=5.0)
        expected = float(np.deg2rad(5.0))
        assert env.initial_elevator_rad == pytest.approx(expected, abs=1e-6)


# ===========================================================================
# F4CPitchEnvNormalized - close() with mocked pygame (lines 974-983)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - _push_history edge cases
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - render with mocked pygame (lines 913-970)
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - draw helpers with mocked pygame
# ===========================================================================
...
# ===========================================================================
# F4CPitchEnvNormalized - _init_pygame (lines 749-789)
# ===========================================================================


class TestInitPygame:
    """Cover _init_pygame early return path."""
