"""Internal iADP interaction fixture for adaptive_validation_protocol_test.py.

Exercises shared observation timestamps, physical units, actuator feedback
and reference transitions through the native B747 and LAPAN environments.
"""
