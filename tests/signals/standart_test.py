...
from tensoraerospace.signals.standart import unit_step, sinusoid, constant_line, sinusoid_vertical_shift
...
def test_sinusoid_vertical_shift():
    ...
    assert np.all(result == amplitude * np.sin(2 * np.pi * frequency * tp) + vertical_shift)
